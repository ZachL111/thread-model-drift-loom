"""Regression checks for the thread-model-drift-loom casebook."""
...
from casebook.harness import assert_expected, thread_model_drift_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_model_drift_loom_summary(), assert_expected())
