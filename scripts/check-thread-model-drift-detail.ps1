...
$repo = "thread-model-drift-loom"
$language = "Haskell"
$category = "ML utilities"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/thread-model-drift-walkthrough.md")) {
